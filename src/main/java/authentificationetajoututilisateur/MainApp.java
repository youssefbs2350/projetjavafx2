...
public class MainApp extends Application {
    ...
    public void start(Stage primaryStage) {
        try {
            ...
            String introVideoPath = "C:\\Users\\ThinkPad\\Documents\\esprit\\projetjavafx2-main\\src\\main\\java\\authentificationetajoututilisateur\\intro.mp4";
            ...
            introPlayer.setOnEndOfMedia(() -> {
                try {
                    String fxmlDocPath = "C:\\Users\\ThinkPad\\Documents\\esprit\\projetjavafx2-main\\src\\main\\java\\authentificationetajoututilisateur\\AuthentificationAp.fxml";
                    FileInputStream fxmlStream = new FileInputStream(fxmlDocPath);
                    AnchorPane root = (AnchorPane) loader.load(fxmlStream);
