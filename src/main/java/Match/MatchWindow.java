...
public class MatchWindow extends Application {
    ...
    @FXML
    private TableView<MatchResult> matchResultsTableView;
    @FXML
    private TableColumn<MatchResult, Integer> matchIdColumn;
    @FXML
    private TableColumn<MatchResult, String> teamANameColumn;
    @FXML
    private TableColumn<MatchResult, String> teamBNameColumn;
    @FXML
    private TableColumn<MatchResult, Integer> teamAScoreColumn;
    @FXML
    private TableColumn<MatchResult, Integer> teamBScoreColumn;
    @FXML
    private TableColumn<MatchResult, String> fieldColumn;
    @FXML
    private TableColumn<MatchResult, String> dateMatchColumn;
    @FXML
    private TableColumn<MatchResult, String> cityColumn;
    @FXML
    private TableColumn<MatchResult, Integer> refereeIdColumn;

    @FXML
    private TableView<MatchResult> upcomingMatchesTableView;
    @FXML
    private TableColumn<MatchResult, String> upcomingTeamANameColumn;
    @FXML
    private TableColumn<MatchResult, String> upcomingTeamBNameColumn;
    @FXML
    private TableColumn<MatchResult, String> upcomingFieldColumn;
    @FXML
    private TableColumn<MatchResult, String> upcomingDateMatchColumn;
    @FXML
    private TableColumn<MatchResult, String> upcomingCityColumn;
    @Override
